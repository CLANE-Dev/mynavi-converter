...
STAMP_ANCHOR_DELIVERY = os.environ.get("STAMP_ANCHOR_DELIVERY", "G17")
STAMP_WIDTH_PX_DELIVERY = int(os.environ.get("STAMP_WIDTH_PX_DELIVERY", str(STAMP_WIDTH_PX)))
STAMP_OFFSET_X_PX_DELIVERY = int(os.environ.get("STAMP_OFFSET_X_PX_DELIVERY", "70"))
STAMP_OFFSET_Y_PX_DELIVERY = int(os.environ.get("STAMP_OFFSET_Y_PX_DELIVERY", "20"))
